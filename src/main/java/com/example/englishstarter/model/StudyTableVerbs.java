...
//@Builder
@Entity
@Table(name = "study_table_verbs")
public class StudyTableVerbs {
    public StudyTableVerbs() {
    }

    public StudyTableVerbs(Integer idWord, String loginUser, LocalDate dateOne, LocalDate dateTwo, LocalDate dateThree, Boolean learned, Integer count, LocalDate dateCount) {
        this.idWord = idWord;
...
//    @Temporal(TemporalType.TIMESTAMP)
    ...
    public boolean equals(Object o) {
        ...
        StudyTableVerbs that = (StudyTableVerbs) o;
